...
public class RotarCyborg extends Application
{
	 ...
	 {		 
	        ...
	        rotar.setStyle("-fx-background-color: #28626e; -fx-text-fill: white;");
	        rotar.setOnAction((ActionEvent event) ->{
	        	rotate.play();
	        });
	        ToggleButton transladar=new ToggleButton("Transladar");
	        transladar.setPrefSize(120, 20);
	        transladar.setStyle("-fx-background-color: #a1a2b4; -fx-text-fill: white;");
	        ...
	        detenerTranslacion.setStyle("-fx-background-color: #28626e; -fx-text-fill: white;");
	        detenerTranslacion.setOnAction((ActionEvent event) ->{
	        	translate.stop();
	        });
	        ToggleButton escalar=new ToggleButton("Escalar");
	        escalar.setPrefSize(120, 20);
	        escalar.setStyle("-fx-background-color: #a1a2b4; -fx-text-fill: white;");
