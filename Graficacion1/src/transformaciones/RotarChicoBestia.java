...
public class RotarChicoBestia extends Application
{
	public void start(Stage primaryStage)
	{
        ...
        rotar.setStyle("-fx-background-color: rgb(67, 99, 51); -fx-text-fill: white;");
        rotar.setOnAction((ActionEvent event) ->{
        	rotate.play();
        });
        ToggleButton transladar=new ToggleButton("Transladar");
        transladar.setPrefSize(120, 20);
        transladar.setStyle("-fx-background-color: rgb(204, 26, 150); -fx-text-fill: white;");
        ...
        detenerRotacion.setStyle("-fx-background-color: rgb(105, 214, 51); -fx-text-fill: white;");
        ...
        detenerTranslacion.setStyle("-fx-background-color: rgb(67, 99, 51); -fx-text-fill: white;");
